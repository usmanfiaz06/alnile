      ...
      {loading && (
        ...
        >
          <motion.div
            ...
            className="relative"
          >
            <motion.svg viewBox="0 0 80 80" className="w-20 h-20 mx-auto mb-6" fill="none">
              <motion.circle
                cx="40" cy="40" r="36" stroke="#C5A572" strokeWidth="1"
                initial={{ pathLength: 0 }} animate={{ pathLength: 1 }}
                transition={{ duration: 1.5, ease: "easeInOut" }}
              />
              <motion.path
                d="M22 40C22 40 30 28 46 28C54 28 58 34 58 40C58 46 54 52 46 52C30 52 22 40 22 40Z"
                fill="#C5A572" initial={{ opacity: 0 }} animate={{ opacity: 1 }}
          ...
          <motion.div className="mt-8 w-32 h-0.5 bg-white/10 rounded-full overflow-hidden">
            <motion.div
