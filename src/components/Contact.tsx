...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-padding bg-pearl relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-20 right-0 w-64 h-64 opacity-[0.03]">
        <svg viewBox="0 0 250 250" fill="none">
          <circle cx="125" cy="125" r="120" stroke="#C5A572" strokeWidth="0.5" />
          <circle cx="125" cy="125" r="80" stroke="#C5A572" strokeWidth="0.5" />
        </svg>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <ScrollReveal variant="left" className="lg:col-span-3">
            {submitted ? (
              <div className="glass-card-light rounded-2xl p-12 text-center">
              ...
              <form onSubmit={handleSubmit} className="glass-card-light rounded-2xl p-8 md:p-10">
                <div className="grid sm:grid-cols-2 gap-5 mb-5">
                  <div>
                    <label className="block text-sm font-body font-medium text-navy-700 mb-2">
                      Full Name *
                    </label>
                    <input
                      type="text"
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    placeholder="Tell us about your requirements, the products you're interested in, or any questions you may have..."
                ...
                <label className="flex items-start gap-3 mb-8 cursor-pointer group">
                  ...
                  <span className="text-sm text-navy-500 font-body group-hover:text-navy-700 transition-colors">
                    Also subscribe me to Al Nile Fish updates — new products, expansion news, and partnership opportunities.
                  </span>
                </label>
          ...
          <ScrollReveal variant="right" className="lg:col-span-2">
            <div className="space-y-6">
              ...
              {[
                {
                  title: "Head Office",
                  details: ["Al Nile Fish Import & Export", "Middle East"],
                  icon: (
                ...
                {
                  title: "Email Us",
                  details: ["info@alnilefish.com", "export@alnilefish.com"],
                  icon: (
                    <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.5">
                ...
                {
                  title: "Call Us",
                  details: ["+971 XX XXX XXXX", "+20 XX XXXX XXXX"],
                  icon: (
                    <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.5">
                ...
                <div key={item.title} className="glass-card-light rounded-xl p-5 flex gap-4">
                  ...
                  <div>
                    ...
                    {item.details.map((detail) => (
                      <p key={detail} className="text-sm text-navy-500 font-body">
                        {detail}
                      </p>
                    ))}
                  </div>
